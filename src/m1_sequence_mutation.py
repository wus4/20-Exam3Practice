...
def run_test_zero_changer():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    test2 = ([8, 4, 0, 9], [77, 0, 0, 1, 5, 0], [4, 0, 4], [4, 0, 4])
    expected2 = ([8, 4, 1, 9], [77, 2, 3, 1, 5, 4], [4, 5, 4], [4, 6, 4])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([8, 4, 0, 9], [77, 0, 0, 1, 5, 0], [4, 0, 4], [4, 0, 0])
    expected3 = ([8, 4, 1, 9], [77, 2, 3, 1, 5, 4], [4, 5, 4], [4, 6, 7])
    zero_changer(test3)
    print()
    print('Test 3:')
