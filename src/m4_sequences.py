...
def practice_problem4a(sequence):
    ...
    for k in range (len(sequence)):
        ele=sequence[k]
        if k+1<len(sequence)and sequence[k+1]==ele:
            l.append(k)
    return l
...
def practice_problem4d(sequence):
    ...
    sum=0
    for k in range (len(sequence)):
        if k+1<len(sequence)and is_prime(sequence[k])==True and is_prime(sequence[k+1])==True and sequence[k]!=sequence[k+1]:
            sum=sum+sequence[k]
    return sum
